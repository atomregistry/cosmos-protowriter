...
// Verifies that cosmos-protowriter produces byte-for-byte identical output to @cosmjs
// for MsgExecuteContract (the most common message type)
...
describe('cosmos-protowriter vs @cosmjs', function () {
  ...
  it('produces identical MsgExecuteContract encoding', async function () {
    ...
    console.log("✅ Byte-for-byte match confirmed with @cosmjs for MsgExecuteContract");
  });
});
